"""
Django settings for purple_poetry_42104 project.
...
ROOT_URLCONF = 'purple_poetry_42104.urls'
...
WSGI_APPLICATION = 'purple_poetry_42104.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "purple_poetry_42104 API",
    "DESCRIPTION": "API documentation for purple_poetry_42104 App",
    "VERSION": "v1",
}
